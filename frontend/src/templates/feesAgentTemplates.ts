...
المحكمة الابتدائية بـ ${court} - ${courtSec}
كناش الأنكحة رقم: ${regNum} | صحيفة: ${regPage} | عدد: ${regCount} | بتاريخ: ${regDate}
مذكرة الحفظ للعدل الأول رقم: ${memoNum} | عدد: ${memoCount} | صفحة: ${memoPage}
ملف إذن قاضي الأسرة المكلف بالزواج رقم: ${authNum} بتاريخ: ${authDate}
================================================================================
...
توقيع الزوج: _______________     توقيع الزوجة/الولي: _______________
توقيع العدلين المنتصبين: ________________________
خطاب قاضي التوثيق: ________________________
`;
  }
