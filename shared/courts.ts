 ...
 */
export const COURT_MAPPINGS: CourtMapping[] = [
  {
 ...
 */
export function getAppellateCourts(): string[] {
 ...
 */
export function getPrimaryCourts(appellateCourt: string): string[] {
 ...
 */
export function getCourtMappingJson(appellateCourt: string) {
...
export const FIRST_INSTANCE_COURTS = Array.from(
  new Set(COURT_MAPPINGS.flatMap(m => m.primaryCourts))
);
